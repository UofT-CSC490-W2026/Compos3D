...
parser.add_argument(
    ...
    default="rope",
    choices=["rope", "yarn"],
    help="YaRN patch: choose between baseline RoPE and YaRN-scaled rotary embeddings",
)
parser.add_argument(
    "--rotary-base",
    type=int,
    default=10000,
    help="YaRN patch: expose the rotary theta base to the patch config",
)
parser.add_argument(
    "--yarn-original-sequence-len",
    type=int,
    default=None,
    help="YaRN patch: original context length before applying YaRN scaling",
)
parser.add_argument(
    "--yarn-scale",
    type=float,
    default=1.0,
    help="YaRN patch: interpolation scale used for long-context extension",
)
parser.add_argument(
    "--yarn-beta-fast",
    type=float,
    default=32.0,
    help="YaRN patch: fast-band correction parameter",
)
parser.add_argument(
    "--yarn-beta-slow",
    type=float,
    default=1.0,
    help="YaRN patch: slow-band correction parameter",
)
parser.add_argument(
    "--yarn-attn-factor",
    type=float,
    default=1.0,
    help="YaRN patch: extra scaling applied to YaRN rotary cache magnitudes",
)
...
def build_model_meta(depth):
    ...
    config = GPTConfig(
        ...
        yarn_original_sequence_len=args.yarn_original_sequence_len
        or args.max_seq_len,  # YaRN patch: default to standard RoPE behavior unless explicitly extending context.
