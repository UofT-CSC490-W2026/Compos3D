        ...
        save_checkpoint(
            ...
            optimizer.state_dict(),
            {
                ...
                "model_config": {
                    ...
                    "positional_embedding": model.config.positional_embedding,  # YaRN patch: keep the rotary backend in the saved SFT config.
                    "rotary_base": model.config.rotary_base,  # YaRN patch: preserve any non-default RoPE theta.
                    "yarn_original_sequence_len": model.config.yarn_original_sequence_len,  # YaRN patch: remember the pre-extension context.
                    "yarn_scale": model.config.yarn_scale,  # YaRN patch: propagate long-context scaling into SFT checkpoints.
                    "yarn_beta_fast": model.config.yarn_beta_fast,  # YaRN patch: keep correction-band settings consistent after finetuning.
                    "yarn_beta_slow": model.config.yarn_beta_slow,  # YaRN patch: keep correction-band settings consistent after finetuning.
                    "yarn_attn_factor": model.config.yarn_attn_factor,  # YaRN patch: preserve YaRN cache scaling in downstream checkpoints.
                },
