...
class GPTConfig:
    ...
    mtp_k: int = (
        0  # extra MTP heads (0=disabled); weight-tied to lm_head, no extra params
    )
    rope_type: str = (
        "rope"  # "rope" = standard RoPE, "yarn" = YaRN NTK-by-Parts (Peng et al. 2023)
    )
