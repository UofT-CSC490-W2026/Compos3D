...
class VaseFactory(AssetFactory):
    ...
    def __init__(self, params):
        ...
        if 'Material' not in self.params:
            self.params['Material'] = weighted_sample(material_assignments.marble + material_assignments.tableware)()()
        elif isinstance(self.params['Material'], str):
            mat_class = weighted_sample(material_assignments.marble + material_assignments.tableware)
