...
def _default_sofa_params():
    return {'Dimensions': (1.0, 2.0, 0.85), 'Arm Dimensions': (1.0, 0.1, 0.65), 'Back Dimensions': (0.2, 0.0, 0.65), 'Seat Dimensions': (1.0, 0.9, 0.22), 'Foot Dimensions': (0.15, 0.06, 0.06), 'Baseboard Height': 0.07, 'Backrest Width': 0.15, 'Seat Margin': 0.985, 'Backrest Angle': -0.3, 'arm_width': 0.75, 'Arm Type': ARM_TYPE_SQUARE, 'Arm_height': 0.85, 'arms_angle': 0.5, 'Footrest': False, 'Count': 4, 'Scaling footrest': 1.45, 'Reflection': 0, 'leg_type': False, 'leg_dimensions': 0.6, 'leg_z': 1.5, 'leg_faces': 16, 'Subdivide': True}
...
class SofaFactory(AssetFactory):
    ...
    def create_placeholder(self, **kwargs) -> bpy.types.Object:
        ...
        butil.modify_mesh(obj, 'NODES', node_group=nodegroup_sofa_geometry(), ng_inputs=self.params, apply=True)
