...
def resolve_bedrock_config(*, model_id: str | None = None, region_name: str | None = None) -> BedrockConfig:
...
class BedrockChatClient:
    def __init__(self, config: BedrockConfig | None = None, *, runtime_client: Any | None = None) -> None:
