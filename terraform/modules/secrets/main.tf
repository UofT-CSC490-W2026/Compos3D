...
output "openai_secret_name" { value = aws_secretsmanager_secret.openai_api_key.name }
output "anthropic_secret_name" { value = aws_secretsmanager_secret.anthropic_api_key.name }
output "anyscale_secret_name" { value = aws_secretsmanager_secret.anyscale_api_key.name }
output "wandb_secret_name" { value = aws_secretsmanager_secret.wandb_api_key.name }
